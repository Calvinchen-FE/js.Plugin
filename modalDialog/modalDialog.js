...
(function ($) {
  ...
  function messagebox(container, options) {
    var defaults = {
      width:400,
      height:144,
  ...
  function init(){
    ...
    var btnWrap = $("<div></div>");
    var okBtn =$("<a href='javascript:;' class='moal-btn'>确定</a>");
    var cancelBtn =$("<a href='javascript:;' class='moal-btn'>取消</a>");
